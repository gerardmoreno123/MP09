                    ...
                    <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                        <table class="min-w-full divide-y divide-gray-300">
                            ...
                            <tr>
                                ...
                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500"><?= $task->Nom; ?></td>
                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500"><?= $task->Cognom; ?></td>
                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500"><?= $task->Email; ?></td>
                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500"><?= $task->Password; ?></td>
